const convertCrypto = async (cryptoName, quantity, currencyCode) => {
  try {
...
const convertCurrency = async (currencyCode, quantity, cryptoName) => {
  try {
    const id = cryptoName.toLowerCase();
...
module.exports = { convertCurrency, convertCrypto };
